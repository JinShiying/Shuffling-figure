	...
	$.ajax({
		...
		success:function(data){
			$.each(data,function(i) {
				...
				$figure.html('<div class="goodsTip" goodsID="'+data[i].goodsID+'"><div class="tipPto"><img src = "'+data[i].goodsListImg+'"></div><div class="tipCon"><p class="tipName">'+data[i].goodsName+'</p><div class="tipBottom"><div class="tipLeft"><p><span class="price1">￥'+data[i].price+'</span><span class="price2">￥'+parseInt(data[i].price/discount)+'</span></p><p>'+data[i].discount+'折</p></div><div class="tipRight"><a href="###"><img src="../img/index/bg_car.png"/></a></div></div></div></div>');
